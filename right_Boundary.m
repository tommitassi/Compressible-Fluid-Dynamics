...
%% 5. Creation of the mesh relative to the right boundary:

function [ x, u ] = right_Boundary( x_in, u_in, ub, type, c )

% rightBoundary permits to complete the mesh using the right
% boundary condition and allows to compute the solution in those points.
